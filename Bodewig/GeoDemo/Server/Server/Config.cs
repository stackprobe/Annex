...
namespace Charlotte
{
	public class Config
	{
		...
		/// </summary>
		public string FG_GML_RootDir = @"C:\wb2\20181015_国土数値情報\東京都地図T";

		/// <summary>
		/// MAPPLE道路ネットワークデータ(.mrd) を ConvTokyoRoad に掛けた後のルートディレクトリ
		/// </summary>
		public string MRD_RootDir = @"C:\wb2\20181015_国土数値情報\東京道路網T";
		...
		/// </summary>
		public string Address_RootDir = @"C:\wb2\20181015_国土数値情報\全国住所緯度経度T";
