...
開始
	...
	KCamera.exe [/C] [/M] [/E MonitorCount DiffMagnifBorder] カメラの名前 出力先 画像クオリティ しきい値 予備フレーム数 遅延比較フレーム数
	...
	START "KCamera" /MIN KCamera.exe /C /M /E 5 50 *Venus C:\tmp\KCamera 90 0.00002 50 20
